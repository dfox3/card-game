...
from .presets.tilesets import ASSET_PATH, BOARD_TILES
...
class TileSelector():
    ...
    def draw(self, surface, color, border=False):
        ...
        # pygame.draw.rect(surface, (255,255,255,220), fill)
        ...
        for cell in self.selected_grid:
            ...
            pygame.draw.rect(surface, (255,255,255), selected_tile_out, width=1)
            pygame.draw.rect(surface, color, selected_tile_in, width=1)
        ...
        if border:
            ...
            pygame.draw.rect(surface, (255,255,255), border, width=1)
            ...
            border = pygame.Rect(x_border, y_border, w_border, h_border)
            pygame.draw.rect(surface, (0,0,0), border, width=2)
